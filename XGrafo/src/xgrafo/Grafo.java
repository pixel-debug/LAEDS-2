...
/* ---------- Definição das arestas ---------- */
    ...
    public Aresta proxAdj ( int v) {
        ...
        else return new Aresta (v, this.pos[v], this.matriz_adj[v][this.pos[v]]); // é válida
    }
    ...
    public Aresta retiraAresta ( int v1, int v2) {
        if (this.matriz_adj[v1][v2] == 0) return null ; // Aresta não existe
            ...
            Aresta aresta = new Aresta (v1, v2, this.matriz_adj[v1][v2]) ;
